...
const JobDetails = ({
  ...
  return (
    <>
    {
        currentTab === JobDetailsTab.Details && <JobForm onSubmit={()=>{}}disabled={true} defaultValues={{
            company: job.company,
            role: job?.role,
    ...
    {
        currentTab === JobDetailsTab.Scoring && <ParameterSlider 
           onSubmit={()=>{}}
            initialWeights={job.scoringWeights}        
        />
    }
    </>
  )
